        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="font-bold text-black">Request Number</TableHead>
              <TableHead className="font-bold text-black">Time Approved</TableHead>
              <TableHead className="font-bold text-black">Subscription</TableHead>
              <TableHead className="font-bold text-black">Remaining Time</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
