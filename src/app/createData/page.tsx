...
export default function App() {
  ...
  useEffect(() => {
    if (!initialized) {
      ...
      expiryDate.setDate(expiryDate.getDate() + (randomDuration ?? 0));
  ...
  return (
    ...
    >
      ...
      <input
        ...
        value={startDateValue ? formatDate(new Date(startDateValue)) : ""}
        onChange={(e) =>
      ...
      <input
        ...
        value={expiryDateValue ? formatDate(new Date(expiryDateValue)) : ""}
        onChange={(e) =>
